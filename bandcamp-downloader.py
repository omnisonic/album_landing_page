# source: https://github.com/cisoun/bandcamp-downloader/blob/master/bandcamp.py

# this file gets back everything i need inluding track titles, audio links and cover image.  I commented out the calling of the download fuction.

# from the command linel: python3 bandcamp-downloader.py -d static/audio/john-h-clarke/mosaic-for-shadows/acoustik-guitar -c https://johnhclarke.bandcamp.com/album/acoustik-guitar-full-album
