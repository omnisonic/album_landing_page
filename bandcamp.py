...
# url = "https://johnhclarke.bandcamp.com/track/a-little-song"
...
album = BandcampAlbum.from_url("https://johnhclarke.bandcamp.com/album/string-wood-full-album")
print(f'cover image:  {album.data["image"]}')
# print(album.artist)
